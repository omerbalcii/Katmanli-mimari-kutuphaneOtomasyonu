...
namespace KatmanliMimari
{
    public partial class iade_ve_alim : Form
    {
        ...
        private void dateTimePicker1_ValueChanged(object sender, EventArgs e)
        {
            ...
            //emanet tarihine 7 gün ekleyerek son teslim tarihini belirliyoruz.
            emanet_tarih__son_t.Text = emanettarih.AddDays(7).ToShortDateString();
        }
        ...
        private void emanet_tarih__son_t_TextChanged(object sender, EventArgs e)
        {
